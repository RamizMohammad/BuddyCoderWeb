  ...
  return (
    <div className="flex min-h-dvh items-center justify-center px-4">
      <div className="max-w-md text-center">
        <p className="font-mono text-xs tracking-widest text-muted-foreground">ERR_NOT_FOUND</p>
        <h1 className="mt-3 text-7xl font-bold tracking-tight text-gradient-brand">404</h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "BuddyCode — Premium Online Code Editor & Compiler" },
      {
        name: "description",
        content:
          "BuddyCode is a premium online IDE and compiler for Python, JavaScript, Java, C and C++. Write, compile and run code instantly with zero setup.",
      },
