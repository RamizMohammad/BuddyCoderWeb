...
const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-material-dark text-white flex items-center justify-center px-6 relative overflow-hidden">
      <SeoTags
        title="Register - BuddyCode"
        description="Create a BuddyCode account to save and manage your code files"
        ...
        <div className="bg-surface border border-gray-700 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <Link to="/login" className="text-primary-blue hover:text-blue-400 font-medium transition-colors">
                Login here
              </Link>
            </p>
          </div>
