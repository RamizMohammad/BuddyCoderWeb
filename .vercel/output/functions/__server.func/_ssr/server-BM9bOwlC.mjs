...
import { k as defineHandlerCallback, K as resolveManifestAssetLink, L as resolveManifestCssLink, M as rootRouteId, q as getNormalizedURL, r as getOrigin, H as normalizeSsrResponse, c as attachRouterServerSsrUtils, g as createSerializationAdapter, f as createRawStreamRPCPlugin, w as invariant, z as isNotFound, A as isRedirect, C as isResolvedRedirect, J as replaceSsrResponse, G as mergeHeaders, n as executeRewriteInput, N as stripSsrResponseBody, j as defaultSerovalPlugins, F as makeSerovalPlugin, s as getScriptPreloadAttrs, u as getStylesheetHref, E as isSsrResponse } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CMW-Bpvg.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Cifnacsd.mjs").then((n) => n.r),
    import("./start-mGBP1sni.mjs"),
